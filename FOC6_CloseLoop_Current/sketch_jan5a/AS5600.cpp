...
/*Fuction:Sensor_update 更新传感器数值，返回在full_rotations，逆时针累加-1，顺时针累加1
 *Note: 获取传感器角度 val
 *      获取时间 angle_prev_ts
 *      局部变量：角度差d_angle用于检测圈数，360到0度的突变视为一圈完成
 *      得到全局变量full_rotations总圈数
*/
...
/*Fuction:getVelocity 获取速度
 *Note:
 *    micros()获取速度，储存在angle_prev_ts
 *    上一次的变量保存在 vel_angle_prev_ts
*/
